...
<body style="background:#eee">
	<div class="widget-box">
		...
		<div class="widget-content nopadding">
			<form action="${base_path}exam/addQtnJudge" method="get"
				...
				<div class="control-group">
					<label class="control-label">真假</label>
					<div class="controls">
						<select id="hard" style="width:692px;" name="isCorrect">
				...
				<div class="form-actions">
					<button type="submit" class="btn btn-primary"
						style="position: relative;left: 260px;">添加</button>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
						class="btn btn-danger" href="${base_path}teacher/addQtnPage"
						style="position: relative;left: 260px;">返回</a>
				</div>
			</form>
		</div>
	</div>
