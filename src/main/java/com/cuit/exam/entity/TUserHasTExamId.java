...
/**
 * TUserHasTExamId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TUserHasTExamId implements java.io.Serializable {
	...
	/** default constructor */
	public TUserHasTExamId() {
	}

	/** full constructor */
	public TUserHasTExamId(Integer TUserId, Integer TExamId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TUserHasTExamId))
			return false;
		TUserHasTExamId castOther = (TUserHasTExamId) other;
