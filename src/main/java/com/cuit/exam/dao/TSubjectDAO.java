 ...
 * TSubject entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see com.cuit.exam.entity.TSubject
...
public class TSubjectDAO {
	...
	public TSubject findById(java.lang.Integer id) {
		log.debug("getting TSubject instance with id: " + id);
		try {
			TSubject instance = (TSubject) getCurrentSession().get(
					"com.cuit.exam.entity.TSubject", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<TSubject> findByExample(TSubject instance) {
		log.debug("finding TSubject instance by example");
		try {
			List<TSubject> results = (List<TSubject>) getCurrentSession()
					.createCriteria("com.cuit.exam.entity.TSubject")
	...
	public List<TSubject> findBySubjectName(Object subjectName) {
	...
	public TSubject merge(TSubject detachedInstance) {
		...
		try {
			TSubject result = (TSubject) getCurrentSession().merge(
					detachedInstance);
